...
<body style="margin-top: 0px; margin-left: 0px">
  <form name="appletForm">  
    <applet ID="Morcego" codebase="./lib/wiki3d" archive="morcego-0.5.0RC1.jar?1" code="br.arca.morcego.Morcego" width="{$wiki_3d_width}" height="{$wiki_3d_height}">
      <param name="serverUrl" value="{$base_url}/morcego-wiki3d_xmlrpc.php">
